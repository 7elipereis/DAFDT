DataMergingMatlabUtils MATLAB Java Package
...
- DataMergingMatlabUtils.jar must be included in your CLASSPATH.
...
-MCRInstaller.exe 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for DataMergingMatlabUtils is in the doc directory. When  
